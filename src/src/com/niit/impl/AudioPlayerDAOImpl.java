...
public class AudioPlayerDAOImpl implements AudioPlayerDAO {
    ...
    public AudioPlayerDAOImpl(String songPath) throws UnsupportedAudioFileException,
    ...
    public void pause() {
        ...
        this.currentFram = this.clip.getMicrosecondPosition();
        System.out.println(" Song stopped :: "+this.currentFram+ " ms.");
        clip.stop();
    ...
    public void resumeAudio() throws UnsupportedAudioFileException,
        ...
        clip.close();
        resetAudioStream();
        clip.setMicrosecondPosition(currentFram);
        System.out.println(" play Song (Current Frame)  :: "+this.currentFram+ " ms.");
        this.play();
    }
    //restart
    @Override
    ...
    public void stop() throws UnsupportedAudioFileException,
            IOException, LineUnavailableException{
        System.out.println(" Current Frame Stop at :: "+this.currentFram+ " ms.");
        currentFram = 0L;
        clip.stop();
